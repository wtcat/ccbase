...
function(zephyr_system_include_directories)
  foreach(arg ${ARGV})
    ...
    target_include_directories(common_interface SYSTEM INTERFACE ${path})
  endforeach()
endfunction()
...
function(zephyr_link_libraries)
  target_link_libraries(common_interface INTERFACE ${ARGV})
endfunction()

# See this file section 3.1. target_cc_option
function(zephyr_cc_option)
  foreach(arg ${ARGV})
    target_cc_option(common_interface INTERFACE ${arg})
  endforeach()
endfunction()

function(zephyr_cc_option_fallback option1 option2)
    target_cc_option_fallback(common_interface INTERFACE ${option1} ${option2})
endfunction()

function(zephyr_ld_options)
    target_ld_options(common_interface INTERFACE ${ARGV})
endfunction()

# Getter functions for extracting build information from
# common_interface. Returning lists, and strings is supported, as is
...
function(zephyr_get_include_directories_for_lang lang i)
  ...
  get_property(flags TARGET common_interface PROPERTY INTERFACE_INCLUDE_DIRECTORIES)
...
function(zephyr_get_system_include_directories_for_lang lang i)
  zephyr_get_parse_args(args ${ARGN})
  get_property(flags TARGET common_interface PROPERTY INTERFACE_SYSTEM_INCLUDE_DIRECTORIES)
...
function(zephyr_get_compile_definitions_for_lang lang i)
  zephyr_get_parse_args(args ${ARGN})
  get_property(flags TARGET common_interface PROPERTY INTERFACE_COMPILE_DEFINITIONS)
...
function(zephyr_get_compile_options_for_lang lang i)
  zephyr_get_parse_args(args ${ARGN})
  get_property(flags TARGET common_interface PROPERTY INTERFACE_COMPILE_OPTIONS)
...
function(zephyr_link_interface interface)
  target_link_libraries(${interface} INTERFACE common_interface)
endfunction()
...
function(zephyr_library_compile_options item)
  ...
  # the command line than the the flags from common_interface because
  # common_interface will be the first interface library that flags
  # are taken from.
...
function(zephyr_append_cmake_library library)
  ...
  set_property(GLOBAL APPEND PROPERTY common_libs ${library})
endfunction()
