...
{
    lv_result_t res;
    res = lv_xml_component_register_from_file("A:examples/others/xml/my_h3.xml");
    if(res != LV_RESULT_OK) {
    ...
    lv_xml_component_register_from_file("A:examples/others/xml/my_card.xml");
    lv_xml_component_register_from_file("A:examples/others/xml/my_button.xml");
    lv_xml_component_register_from_file("A:examples/others/xml/view.xml");
