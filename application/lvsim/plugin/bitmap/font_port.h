...
#define bitmap_font_cache_init()
#define bitmap_font_cache_malloc(_s)          malloc(_s)
#define bitmap_font_cache_free(_p)            free(_p)

/* Bitmap Font */
#define emoji_font_use_mmap()                 1
#define bitmap_font_get_font_cache_size()     32768
#define bitmap_font_get_max_fonts_num()       12
#define bitmap_font_glyph_err_print_is_on()   0
#define bitmap_font_glyph_debug_is_on()       0
#define bitmap_font_cache_dump_info()
#define bitmap_font_get_max_emoji_num()       0
#define bitmap_font_get_high_freq_enabled()   0
