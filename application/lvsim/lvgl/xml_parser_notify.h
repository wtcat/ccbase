...
LV_XML_PARSER_EXTERN lv_xml_parser_callback_t _string_parser_callback;
...
static inline void lv_xml_register_string_parser_cb(lv_xml_parser_callback_t cb) {
    _string_parser_callback = cb;
}
